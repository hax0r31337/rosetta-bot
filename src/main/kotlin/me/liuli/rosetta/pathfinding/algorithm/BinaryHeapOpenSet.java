...
public final class BinaryHeapOpenSet {
    ...
    public void push(PathNode value) {
    ...
    public void update(PathNode val) {
        ...
        double cost = val.getF();
        PathNode parentNode = array[parentInd];
        while (index > 1 && parentNode.getF() > cost) {
    ...
    public PathNode pop() {
        ...
        do {
            ...
            double smallerChildCost = smallerChildNode.getF();
            if (smallerChild < size) {
                PathNode rightChildNode = array[smallerChild + 1];
                double rightChildCost = rightChildNode.getF();
